...
let me show you how to use this repo,

1. run `npm i -g expo-cli` anywhere in terminal,
2. go to app store on your phone and download Expo, it's an app that let you live preview you react native app
